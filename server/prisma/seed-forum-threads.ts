...
async function main() {
  ...
  // Create 10 sample forum threads (2 per category)
  const threads = [
    {
      ...
      categoryId: categories[0].id, // Pregnancy & Fertility
    ...
    },
    {
      ...
      categoryId: categories[1].id, // Parenting & Childcare
      createdById: testUserId,
    },
    {
    ...
    },
    {
      ...
      categoryId: categories[2].id, // Health & Wellness
      createdById: testUserId,
    },
    {
    ...
    },
    {
      ...
      categoryId: categories[3].id, // Relationships & Support
      createdById: testUserId,
    },
    {
    ...
    },
    {
      ...
      categoryId: categories[4].id, // Career & Lifestyle
      createdById: testUserId,
    },
    {
