...
const UNUSED_ASSET_PATHS = [
  ...
  'src/assets/branding/dorehealth-icon.svg',
  'src/assets/branding/dorehealth-logo.svg',
  'src/assets/branding/dorehealth-wordmark.svg',
  'src/assets/branding/dorehealth-splash-name.svg',
