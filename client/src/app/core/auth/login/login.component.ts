...
import { LANGUAGE_SWITCHING_ENABLED } from '@app/shared/services/language.service';
import {
  OnboardingDataDto,
  OnboardingService,
...
import {
  ...
  resolveApiMessage,
} from '@app/shared/utils/resolve-api-message.util';
import {
  mapLocalOnboardingToReproductiveInit,
  type LocalOnboardingAnswers,
} from '@app/shared/utils/onboarding-reproductive.util';
import {
  EMAIL_OTP_LENGTH,
  EMAIL_OTP_VALIDITY_MS,
  SMS_OTP_VALIDITY_MS,
  markEmailVerificationSent,
} from '@app/core/auth/constants/email-verification.constants';
import { TokenResponse } from '@app/core/auth/models/token.interface';
import {
  AppleSignInNotConfiguredError,
  AppleSignInService,
} from '@app/core/auth/services/apple-sign-in.service';
import { AuthService } from '@app/core/auth/services/auth';
import {
  GoogleSignInNotConfiguredError,
  GoogleSignInService,
} from '@app/core/auth/services/google-sign-in.service';
