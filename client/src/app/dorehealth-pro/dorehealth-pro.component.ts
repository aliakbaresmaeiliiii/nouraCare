...
@Component({
  selector: 'app-dorehealth-pro',
  templateUrl: './dorehealth-pro.component.html',
  styleUrls: ['./dorehealth-pro.component.scss'],
  standalone: true,
  imports: [...SHARED_STANDALONE_IMPORTS],
  host: { class: 'ion-page' },
})
export class DorehealthProComponent implements OnInit, ViewWillEnter {
