...
export class TranslationService {
  private translations: { [key: string]: { [key: string]: string } } = {
    en: {
      ...
      'cycleChart.view.todayOnCycle': 'Today on your cycle',
      'cycleChart.view.previewTapAnotherDay': 'Preview · tap another day or tap Today to return',
    ...
    zh: {
      ...
      'cycleChart.view.todayOnCycle': '今天在你的周期中',
      'cycleChart.view.previewTapAnotherDay': '预览 · 点选其他日期，或点今天返回',
    ...
    ms: {
      ...
      'cycleChart.view.todayOnCycle': 'Hari ini dalam kitaran anda',
      'cycleChart.view.previewTapAnotherDay': 'Pratonton · ketik hari lain atau ketik Hari Ini untuk kembali',
    ...
    fa: {
      ...
      'cycleChart.view.todayOnCycle': 'امروز در چرخه شما',
      'cycleChart.view.previewTapAnotherDay': 'پیش‌نمایش · روز دیگری را بزنید یا برای بازگشت روی امروز بزنید',
