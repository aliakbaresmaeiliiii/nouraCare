...
export class TranslationService {
  private translations: { [key: string]: { [key: string]: string } } = {
    en: {
      ...
      'pregnancySetup.title': 'Pregnancy dates',
      'pregnancySetup.intro':
        'Choose one way to set your timeline. We store only your last period start (LMP).',
      'pregnancySetup.modeLmp': 'Last period',
      'pregnancySetup.modeWeek': 'Weeks',
      'pregnancySetup.modeDue': 'Due date',
      'pregnancySetup.lmpLabel': 'First day of last period',
      'pregnancySetup.legendBleeding': 'Bleeding days (estimate)',
      'pregnancySetup.legendOvulation': 'Estimated ovulation',
      'pregnancySetup.weekLabel': 'Completed weeks since LMP (0–42)',
      'pregnancySetup.weekHint':
        'We set LMP as today minus this many full weeks (day within the week starts at 0).',
      'pregnancySetup.dueLabel': 'Estimated due date',
      'pregnancySetup.dueHint': 'LMP is calculated as your due date minus 280 days.',
      'pregnancySetup.validationLmpRequired':
        'Please choose your last period start date (LMP).',
      'pregnancySetup.validationLmpFuture': 'LMP cannot be in the future.',
      'pregnancySetup.validationWeekRequired':
        'Please enter how many full weeks you are along (0–42).',
      'pregnancySetup.validationWeekRange': 'Week must be between 0 and 42.',
    ...
    zh: {
      ...
      'pregnancySetup.title': '孕期日期',
      'pregnancySetup.intro': '选择一种方式设置时间线。我们仅保存末次月经（LMP）。',
      'pregnancySetup.modeLmp': '末次月经',
      'pregnancySetup.modeWeek': '孕周',
      'pregnancySetup.modeDue': '预产期',
      'pregnancySetup.lmpLabel': '末次月经第一天',
      'pregnancySetup.legendBleeding': '出血天数（估计）',
      'pregnancySetup.legendOvulation': '预计排卵日',
      'pregnancySetup.weekLabel': '末次月经以来的完整孕周（0–42）',
      'pregnancySetup.weekHint': 'LMP 设为今天减去相应完整孕周（周内从第 0 天起算）。',
      'pregnancySetup.dueLabel': '预计预产期',
      'pregnancySetup.dueHint': 'LMP 按预产期减去 280 天计算。',
      'pregnancySetup.validationLmpRequired': '请选择末次月经第一天（LMP）。',
      'pregnancySetup.validationLmpFuture': 'LMP 不能是未来日期。',
      'pregnancySetup.validationWeekRequired': '请输入完整孕周（0–42）。',
      'pregnancySetup.validationWeekRange': '孕周须在 0 到 42 之间。',
    ...
    ms: {
      ...
      'pregnancySetup.title': 'Tarikh kehamilan',
      'pregnancySetup.intro':
        'Pilih satu cara untuk menetapkan garis masa. Kami hanya simpan tarikh mula haid terakhir (LMP).',
      'pregnancySetup.modeLmp': 'Haid terakhir',
      'pregnancySetup.modeWeek': 'Minggu',
      'pregnancySetup.modeDue': 'Tarikh jangka',
      'pregnancySetup.lmpLabel': 'Hari pertama haid terakhir',
      'pregnancySetup.legendBleeding': 'Hari pendarahan (anggaran)',
      'pregnancySetup.legendOvulation': 'Anggaran ovulasi',
      'pregnancySetup.weekLabel': 'Minggu penuh sejak LMP (0–42)',
      'pregnancySetup.weekHint':
        'LMP ditetapkan sebagai hari ini tolak bilangan minggu penuh (hari dalam minggu bermula 0).',
      'pregnancySetup.dueLabel': 'Tarikh jangka bersalin',
      'pregnancySetup.dueHint': 'LMP dikira sebagai tarikh jangka tolak 280 hari.',
      'pregnancySetup.validationLmpRequired':
        'Sila pilih tarikh mula haid terakhir (LMP).',
      'pregnancySetup.validationLmpFuture': 'LMP tidak boleh pada masa hadapan.',
      'pregnancySetup.validationWeekRequired':
        'Sila masukkan bilangan minggu penuh (0–42).',
      'pregnancySetup.validationWeekRange': 'Minggu mesti antara 0 dan 42.',
    ...
    fa: {
      ...
      'pregnancySetup.title': 'تاریخ‌های بارداری',
      'pregnancySetup.intro':
        'یک روش برای تعیین خط زمانی انتخاب کنید. فقط تاریخ شروع آخرین پریود (LMP) ذخیره می‌شود.',
      'pregnancySetup.modeLmp': 'آخرین پریود',
      'pregnancySetup.modeWeek': 'هفته',
      'pregnancySetup.modeDue': 'تاریخ زایمان',
      'pregnancySetup.lmpLabel': 'روز اول آخرین پریود',
      'pregnancySetup.legendBleeding': 'روزهای خونریزی (تخمینی)',
      'pregnancySetup.legendOvulation': 'تخمک‌گذاری تخمینی',
      'pregnancySetup.weekLabel': 'هفته‌های کامل از LMP (۰–۴۲)',
      'pregnancySetup.weekHint':
        'LMP برابر امروز منهای این تعداد هفته کامل است (روز در هفته از ۰ شروع می‌شود).',
      'pregnancySetup.dueLabel': 'تاریخ تقریبی زایمان',
      'pregnancySetup.dueHint': 'LMP از تاریخ زایمان منهای ۲۸۰ روز محاسبه می‌شود.',
      'pregnancySetup.validationLmpRequired':
        'لطفاً تاریخ شروع آخرین پریود (LMP) را انتخاب کنید.',
      'pregnancySetup.validationLmpFuture': 'LMP نمی‌تواند در آینده باشد.',
      'pregnancySetup.validationWeekRequired':
        'لطفاً تعداد هفته‌های کامل (۰–۴۲) را وارد کنید.',
      'pregnancySetup.validationWeekRange': 'هفته باید بین ۰ تا ۴۲ باشد.',
