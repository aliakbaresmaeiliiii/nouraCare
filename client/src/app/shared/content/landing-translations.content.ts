...
const LANDING_EN: Record<string, string> = {
  ...
  'landing.how.title': 'Three calm steps to get started',
  'landing.how.lede': 'No clutter. Just a clear path into your health companion.',
  'landing.how.1.title': 'Create your space',
  'landing.how.1.body': 'Sign in securely and set your language, profile, and preferences.',
  'landing.how.2.title': 'Track what matters',
  'landing.how.2.body': 'Log cycles, symptoms, and milestones in a timeline made for daily use.',
  'landing.how.3.title': 'Grow with guidance',
  'landing.how.3.body': 'Open insights, tools, school content, and care when you need them.',
  ...
  'landing.footer.screenshots': 'Product',
...
const LANDING_FA: Record<string, string> = {
  ...
  'landing.nav.menuTitle': 'منو',
  'landing.nav.closeMenu': 'بستن منو',
  'landing.brandAlt': 'لوگوی دوره',
  ...
  'landing.how.eyebrow': 'نحوه کار',
  'landing.how.title': 'سه گام آرام برای شروع',
  'landing.how.lede': 'بدون شلوغی. فقط مسیری روشن به همراه سلامت شما.',
  'landing.how.1.title': 'فضای خود را بسازید',
  'landing.how.1.body': 'با امنیت وارد شوید و زبان، پروفایل و ترجیحات‌تان را تنظیم کنید.',
  'landing.how.2.title': 'آنچه مهم است را ثبت کنید',
  'landing.how.2.body': 'چرخه، علائم و نقاط عطف را در خط زمانی مناسب استفاده روزانه ثبت کنید.',
  'landing.how.3.title': 'با راهنمایی رشد کنید',
  'landing.how.3.body': 'بینش‌ها، ابزارها، محتوای آموزشی و مراقبت را وقتی نیاز دارید باز کنید.',
  ...
  'landing.footer.company': 'شرکت',
  'landing.footer.features': 'امکانات',
  'landing.footer.how': 'نحوه کار',
  'landing.footer.faq': 'سؤالات متداول',
  'landing.footer.screenshots': 'محصول',
  'landing.footer.signIn': 'ورود',
  'landing.footer.openApp': 'ورود به اپ',
...
const LANDING_ZH: Record<string, string> = {
  ...
  'landing.how.eyebrow': '如何使用',
  'landing.how.title': '三个轻松步骤开始',
...
const LANDING_MS: Record<string, string> = {
  ...
  'landing.nav.how': 'Cara berfungsi',
  'landing.nav.faq': 'Soalan lazim',
  'landing.nav.cta': 'Mulakan',
  ...
  'landing.how.eyebrow': 'Cara berfungsi',
  'landing.how.title': 'Tiga langkah tenang untuk bermula',
