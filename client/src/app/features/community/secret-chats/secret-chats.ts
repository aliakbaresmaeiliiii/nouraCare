...
import { SecretChat, CreateSecretChatDto } from '@app/features/community/secret-chats/secret.chats.dto';
...
export class SecretChatsComponent implements OnInit {
  ...
  async createNewPost() {
    ...
    const { CreatePostModalComponent } = await import(
      '@app/shared/ui/create-post-modal/create-post-modal.component'
    );
